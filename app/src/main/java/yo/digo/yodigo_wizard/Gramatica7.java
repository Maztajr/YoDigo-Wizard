...
public class Gramatica7 extends Gramatica {

	ArrayList<Integer> added;

	public Gramatica7(ArrayList<Elemento> m, Context con){
		super(m,con);
	...
	public void validarElemento(Elemento e){
		if( tiposPermitidos.contains(e.getClasificacion()) ){
			...
			if(ban==0){
				...
				} else if (e.getClasificacion() == DatabaseHelper.PRONOMBRE_REFLEXIVO){
					mensaje.set(1, e);
